...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (mode-line                                 (:background gruvbox-dark1 :foreground gruvbox-light4 :box nil))
     (mode-line-inactive                        (:background gruvbox-dark0 :foreground gruvbox-dark4 :box nil))
     (fringe                                    (:background gruvbox-bg :foreground gruvbox-dark3))
     (hl-line                                   (:background gruvbox-dark1))
     (region                                    (:background gruvbox-dark2)) ;;selection
     (secondary-selection                       (:background gruvbox-dark1))
     (minibuffer-prompt                         (:foreground gruvbox-neutral_aqua :bold t))
     ...
     (highlight                                         (:background gruvbox-dark1))
     ...
     (line-number-current-line                  (:foreground gruvbox-bright_yellow :background gruvbox-dark0_hard))
     ...
     (org-level-1                               (:foreground gruvbox-bright_purple))
     (org-level-2                               (:foreground gruvbox-bright_yellow))
     (org-level-3                               (:foreground gruvbox-bright_green))
     (org-level-4                               (:foreground gruvbox-bright_purple))
     (org-level-5                               (:foreground gruvbox-bright_yellow))
     (org-level-6                               (:foreground gruvbox-bright_green))
     (org-level-7                               (:foreground gruvbox-bright_purple))
     (org-level-8                               (:foreground gruvbox-bright_yellow))
     ...
     (org-tag                                   (:foreground gruvbox-aquamarine4))
     (org-list-dt                               (:bold t :weight 'bold))
     (org-priority                              (:foreground gruvbox-lightblue4 :weight 'bold :bold t))
     (org-todo                                  (:foreground gruvbox-sienna :weight 'bold :bold t))
     (org-done                                  (:foreground gruvbox-burlywood4 :weight 'bold :bold t))
     ...
     (org-block-begin-line                      (:foreground gruvbox-faded_green :weight 'light :height 0.8))
     (org-block-end-line                        (:foreground gruvbox-faded_green :weight 'light :height 0.8))
     (org-meta-line                             (:foreground gruvbox-faded_green))
     ...
     (org-code                                  (:foreground gruvbox-bright_orange))

     ;;; org-modern

     (org-modern-horizontal-rule                (:inherit 'org-hide :strike-through gruvbox-dark2))
     (org-modern-date-active                    (:inherit 'org-modern-label :weight 'semibold :foreground gruvbox-bright_blue))
     (org-modern-date-inactive                  (:inherit 'org-modern-label :foreground gruvbox-faded_blue))
     (org-modern-time-active                    (:inherit 'org-modern-label :weight 'semibold :foreground gruvbox-bright_aqua))
     (org-modern-time-inactive                  (:inherit 'org-modern-label :foreground gruvbox-faded_aqua))
     ...
     (solaire-default-face        (:background gruvbox-dark0_hard))
     (solaire-minibuffer-face     (:background gruvbox-dark0_hard))
     (solaire-hl-line-face        (:background gruvbox-dark0_hard))
     (solaire-org-hide-face       (:background gruvbox-dark0_hard))
